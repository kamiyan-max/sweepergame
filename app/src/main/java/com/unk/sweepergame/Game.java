        ...
        for (int x = 0 ; x < 9 ; x++) {
            for (int y = 0 ; y < 9 ; y++) {
                ...
                if (tile.hasMine () && !hasWon) {
                    tile.setState (State.UNK);
                }
            }
        }

        if (hasWon) {
            Toast.makeText (activity, "You did it!", Toast.LENGTH_LONG).show ();
            ...
            Toast.makeText (activity, "Oh~~~NOOOOO!!!", Toast.LENGTH_LONG).show ();
        }
        over = true;
    }
